...
var constants = require('./constants-0d108348.js');
...
var deserializeAws_queryAssumeRoleResponse = function (output, context) {
    ...
    if (output["PackedPolicySize"] !== undefined) {
        contents.PackedPolicySize = serdePlugin.strictParseInt32(output["PackedPolicySize"]);
    }
...
var deserializeAws_queryCredentials = function (output, context) {
    ...
    if (output["Expiration"] !== undefined) {
        contents.Expiration = serdePlugin.expectNonNull(constants.parseRfc3339DateTime(output["Expiration"]));
    }
    return contents;
};
...
var memoize = function (provider, isExpired, requiresRefresh) {
    ...
    var coalesceProvider = function () { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!pending) {
...
var getSigningKey = function (sha256Constructor, credentials, shortDate, region, service) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    ...
    return serdePlugin.__generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                credsHash = _d.sent();
                cacheKey = shortDate + ":" + region + ":" + service + ":" + index.toHex(credsHash) + ":" + credentials.sessionToken;
...
var moveHeadersToQuery = function (request, options) {
    ...
    return serdePlugin.__assign(serdePlugin.__assign({}, request), { headers: headers, query: query });
};
    ...
    if (input.signer) {
        ...
        signer = function () {
            return normalizeProvider(input.region)()
                ...
                var params = serdePlugin.__assign(serdePlugin.__assign({}, input), { credentials: normalizedCreds, region: input.signingRegion, service: input.signingName, sha256: sha256, uriEscapePath: signingEscapePath });
                var signerConstructor = input.signerConstructor || SignatureV4;
                return new signerConstructor(params);
            });
        };
    }
    return serdePlugin.__assign(serdePlugin.__assign({}, input), { systemClockOffset: systemClockOffset, signingEscapePath: signingEscapePath, credentials: normalizedCreds, signer: signer });
};
...
var resolveEndpointsConfig = function (input) {
    var _a;
    return (serdePlugin.__assign(serdePlugin.__assign({}, input), { tls: (_a = input.tls) !== null && _a !== void 0 ? _a : true, endpoint: input.endpoint
            ? normalizeEndpoint(serdePlugin.__assign(serdePlugin.__assign({}, input), { endpoint: input.endpoint }))
...
var getRegionInfo = function (region, _a) {
    ...
    return serdePlugin.__assign(serdePlugin.__assign({ partition: partition, signingService: signingService, hostname: getResolvedHostname(resolvedRegion, { signingService: signingService, regionHash: regionHash, partitionHash: partitionHash }) }, (((_d = regionHash[resolvedRegion]) === null || _d === void 0 ? void 0 : _d.signingRegion) && {
...
var getRetryMode = function (retryMode) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    return serdePlugin.__generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
var defaultRegionInfoProvider$1 = function (region, options) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    return serdePlugin.__generator(this, function (_a) {
        return [2 /*return*/, getRegionInfo(region, serdePlugin.__assign(serdePlugin.__assign({}, options), { signingService: "awsssoportal", regionHash: regionHash$1, partitionHash: partitionHash$1 }))];
    });
}); };
...
(function (GetRoleCredentialsRequest) {
     ...
     * @internal
     */
    GetRoleCredentialsRequest.filterSensitiveLog = function (obj) { return (serdePlugin.__assign(serdePlugin.__assign({}, obj), (obj.accessToken && { accessToken: constants.SENSITIVE_STRING }))); };
...
(function (RoleCredentials) {
     ...
     * @internal
     */
    RoleCredentials.filterSensitiveLog = function (obj) { return (serdePlugin.__assign(serdePlugin.__assign(serdePlugin.__assign({}, obj), (obj.secretAccessKey && { secretAccessKey: constants.SENSITIVE_STRING })), (obj.sessionToken && { sessionToken: constants.SENSITIVE_STRING }))); };
...
(function (ListAccountRolesRequest) {
     ...
     * @internal
     */
    ListAccountRolesRequest.filterSensitiveLog = function (obj) { return (serdePlugin.__assign(serdePlugin.__assign({}, obj), (obj.accessToken && { accessToken: constants.SENSITIVE_STRING }))); };
...
(function (ListAccountsRequest) {
     ...
     * @internal
     */
    ListAccountsRequest.filterSensitiveLog = function (obj) { return (serdePlugin.__assign(serdePlugin.__assign({}, obj), (obj.accessToken && { accessToken: constants.SENSITIVE_STRING }))); };
...
(function (LogoutRequest) {
     ...
     * @internal
     */
    LogoutRequest.filterSensitiveLog = function (obj) { return (serdePlugin.__assign(serdePlugin.__assign({}, obj), (obj.accessToken && { accessToken: constants.SENSITIVE_STRING }))); };
    ...
    return serdePlugin.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = serdePlugin.expectNonNull;
                _b = serdePlugin.expectObject;
...
var deserializeAws_restJson1RoleCredentials = function (output, context) {
    return {
        ...
        expiration: serdePlugin.expectLong(output.expiration),
...
var resolveTokenFile = function (init) {
    ...
    return fromWebToken(serdePlugin.__assign(serdePlugin.__assign({}, init), { webIdentityToken: fs.readFileSync(webIdentityTokenFile, { encoding: "ascii" }), roleArn: roleArn, roleSessionName: roleSessionName }))();
};
...
var defaultRegionInfoProvider = function (region, options) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    return serdePlugin.__generator(this, function (_a) {
        return [2 /*return*/, getRegionInfo(region, serdePlugin.__assign(serdePlugin.__assign({}, options), { signingService: "sts", regionHash: regionHash, partitionHash: partitionHash }))];
    });
}); };
