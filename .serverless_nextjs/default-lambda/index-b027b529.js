...
var index = require('./index-eea49899.js');
...
var getEndpointFromArn = function (options) {
    ...
    if (service === "s3-object-lambda") {
        return getEndpointFromObjectLambdaArn(serdePlugin.__assign(serdePlugin.__assign({}, options), { tlsCompatible: tlsCompatible, bucketName: bucketName, accesspointName: accesspointName, hostnameSuffix: hostnameSuffix }));
    }
    if (region === "") {
        return getEndpointFromMRAPArn(serdePlugin.__assign(serdePlugin.__assign({}, options), { clientRegion: clientRegion, mrapAlias: accesspointName, hostnameSuffix: hostnameSuffix }));
    }
    if (outpostId) {
        return getEndpointFromOutpostArn(serdePlugin.__assign(serdePlugin.__assign({}, options), { clientRegion: clientRegion, outpostId: outpostId, accesspointName: accesspointName, hostnameSuffix: hostnameSuffix }));
    }
    return getEndpointFromAccessPointArn(serdePlugin.__assign(serdePlugin.__assign({}, options), { clientRegion: clientRegion, accesspointName: accesspointName, hostnameSuffix: hostnameSuffix }));
};
...
var bucketEndpointMiddleware = function (options) { return function (next, context) { return function (args) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    ...
    return serdePlugin.__generator(this, function (_j) {
        switch (_j.label) {
            case 0:
                ...
                if (!serdePlugin.HttpRequest.isInstance(request)) return [3 /*break*/, 9];
            ...
            case 8:
                ...
                _j.label = 9;
            case 9: return [2 /*return*/, next(serdePlugin.__assign(serdePlugin.__assign({}, args), { request: request }))];
        }
    });
}); }; }; };
...
(function (CompleteMultipartUploadOutput) {
    ...
    CompleteMultipartUploadOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.SSEKMSKeyId && { SSEKMSKeyId: constants.SENSITIVE_STRING }),
    });
...
(function (CopyObjectOutput) {
    ...
    CopyObjectOutput.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.SSEKMSKeyId && { SSEKMSKeyId: constants.SENSITIVE_STRING }),
        ...(obj.SSEKMSEncryptionContext && { SSEKMSEncryptionContext: constants.SENSITIVE_STRING }),
    });
...
(function (CopyObjectRequest) {
    ...
    CopyObjectRequest.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.SSECustomerKey && { SSECustomerKey: constants.SENSITIVE_STRING }),
        ...(obj.SSEKMSKeyId && { SSEKMSKeyId: constants.SENSITIVE_STRING }),
        ...(obj.SSEKMSEncryptionContext && { SSEKMSEncryptionContext: constants.SENSITIVE_STRING }),
        ...(obj.CopySourceSSECustomerKey && { CopySourceSSECustomerKey: constants.SENSITIVE_STRING }),
    });
...
(function (ServerSideEncryptionByDefault) {
    ...
    ServerSideEncryptionByDefault.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.KMSMasterKeyID && { KMSMasterKeyID: constants.SENSITIVE_STRING }),
    });
...
(function (SSEKMS) {
    ...
    SSEKMS.filterSensitiveLog = (obj) => ({
        ...obj,
        ...(obj.KeyId && { KeyId: constants.SENSITIVE_STRING }),
    });
})(SSEKMS || (SSEKMS = {}));
var SSES3;
(function (SSES3) {
...
const serializeAws_restXmlGetObjectCommand = async (input, context) => {
    ...
    const headers = {
        ...
        ...(isSerializableHeaderValue(input.IfModifiedSince) && {
            "if-modified-since": constants.dateToUtcString(input.IfModifiedSince).toString(),
        }),
        ...(isSerializableHeaderValue(input.IfNoneMatch) && { "if-none-match": input.IfNoneMatch }),
        ...(isSerializableHeaderValue(input.IfUnmodifiedSince) && {
            "if-unmodified-since": constants.dateToUtcString(input.IfUnmodifiedSince).toString(),
        }),
    ...
    const query = {
        ...
        ...(input.ResponseExpires !== undefined && {
            "response-expires": constants.dateToUtcString(input.ResponseExpires).toString(),
        }),
...
const serializeAws_restXmlPutObjectCommand = async (input, context) => {
    ...
    const headers = {
        ...
        ...(isSerializableHeaderValue(input.Expires) && { expires: constants.dateToUtcString(input.Expires).toString() }),
...
const deserializeAws_restXmlGetObjectCommand = async (output, context) => {
    ...
    if (output.headers["last-modified"] !== undefined) {
        contents.LastModified = serdePlugin.expectNonNull(constants.parseRfc7231DateTime(output.headers["last-modified"]));
    }
    if (output.headers["content-length"] !== undefined) {
        contents.ContentLength = serdePlugin.strictParseLong(output.headers["content-length"]);
    }
    if (output.headers["etag"] !== undefined) {
        contents.ETag = output.headers["etag"];
    }
    if (output.headers["x-amz-missing-meta"] !== undefined) {
        contents.MissingMeta = serdePlugin.strictParseInt32(output.headers["x-amz-missing-meta"]);
    }
    ...
    if (output.headers["expires"] !== undefined) {
        contents.Expires = serdePlugin.expectNonNull(constants.parseRfc7231DateTime(output.headers["expires"]));
    }
    ...
    if (output.headers["x-amz-mp-parts-count"] !== undefined) {
        contents.PartsCount = serdePlugin.strictParseInt32(output.headers["x-amz-mp-parts-count"]);
    }
    if (output.headers["x-amz-tagging-count"] !== undefined) {
        contents.TagCount = serdePlugin.strictParseInt32(output.headers["x-amz-tagging-count"]);
    }
    ...
    if (output.headers["x-amz-object-lock-retain-until-date"] !== undefined) {
        contents.ObjectLockRetainUntilDate = serdePlugin.expectNonNull(constants.parseRfc3339DateTime(output.headers["x-amz-object-lock-retain-until-date"]));
    }
