...
var fs = require('fs');
require('http2');
var index$1 = require('./index-eea49899.js');
...
var Int64 = /** @class */ (function () {
    ...
    Int64.prototype.valueOf = function () {
        ...
        return parseInt(index.toHex(bytes), 16) * (negative ? -1 : 1);
    };
    ...
    HeaderMarshaller.prototype.formatHeaderValue = function (header) {
        switch (header.type) {
            ...
            case "uuid":
                ...
                uuidBytes[0] = 9 /* uuid */;
                uuidBytes.set(index.fromHex(header.value.replace(/\-/g, "")), 1);
                return uuidBytes;
        }
    };
        ...
        while (position < headers.byteLength) {
            ...
            switch (headers.getUint8(position++)) {
                ...
                case 9 /* uuid */:
                    ...
                    out[name] = {
                        type: UUID_TAG,
                        value: index.toHex(uuidBytes.subarray(0, 4)) + "-" + index.toHex(uuidBytes.subarray(4, 6)) + "-" + index.toHex(uuidBytes.subarray(6, 8)) + "-" + index.toHex(uuidBytes.subarray(8, 10)) + "-" + index.toHex(uuidBytes.subarray(10)),
                    };
                    break;
                default:
    ...
    return function (next) {
        return function (args) { return serdePlugin.__awaiter(_this, void 0, void 0, function () {
            ...
            return serdePlugin.__generator(this, function (_a) {
                ...
                if (typeof Bucket === "string" && !index$1.validate(Bucket) && Bucket.indexOf("/") >= 0) {
...
var S3SignatureV4 = /** @class */ (function () {
    function S3SignatureV4(options) {
        this.sigv4Signer = new defaultRoleAssumers.SignatureV4(options);
            ...
            return serdePlugin.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        throw e_1;
                    case 4:
                        this.sigv4aSigner = new CrtSignerV4_1(serdePlugin.__assign(serdePlugin.__assign({}, this.signerOptions), { signingAlgorithm: 1 }));
                        _a.label = 5;
...
const getRuntimeConfig$1 = (config) => {
    ...
    return ({
        ...
        urlParser: (_g = config === null || config === void 0 ? void 0 : config.urlParser) !== null && _g !== void 0 ? _g : defaultRoleAssumers.parseUrl,
...
const getRuntimeConfig = (config) => {
    ...
    return {
        ...
        maxAttempts: (_g = config === null || config === void 0 ? void 0 : config.maxAttempts) !== null && _g !== void 0 ? _g : defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_MAX_ATTEMPT_CONFIG_OPTIONS),
        md5: (_h = config === null || config === void 0 ? void 0 : config.md5) !== null && _h !== void 0 ? _h : defaultRoleAssumers.Hash.bind(null, "md5"),
        region: (_j = config === null || config === void 0 ? void 0 : config.region) !== null && _j !== void 0 ? _j : defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_REGION_CONFIG_OPTIONS, defaultRoleAssumers.NODE_REGION_CONFIG_FILE_OPTIONS),
        requestHandler: (_k = config === null || config === void 0 ? void 0 : config.requestHandler) !== null && _k !== void 0 ? _k : new defaultRoleAssumers.NodeHttpHandler(),
        retryMode: (_l = config === null || config === void 0 ? void 0 : config.retryMode) !== null && _l !== void 0 ? _l : defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_RETRY_MODE_CONFIG_OPTIONS),
        sha256: (_m = config === null || config === void 0 ? void 0 : config.sha256) !== null && _m !== void 0 ? _m : defaultRoleAssumers.Hash.bind(null, "sha256"),
        streamCollector: (_o = config === null || config === void 0 ? void 0 : config.streamCollector) !== null && _o !== void 0 ? _o : defaultRoleAssumers.streamCollector,
        streamHasher: (_p = config === null || config === void 0 ? void 0 : config.streamHasher) !== null && _p !== void 0 ? _p : fileStreamHasher,
        useArnRegion: (_q = config === null || config === void 0 ? void 0 : config.useArnRegion) !== null && _q !== void 0 ? _q : defaultRoleAssumers.loadConfig(NODE_USE_ARN_REGION_CONFIG_OPTIONS),
        utf8Decoder: (_r = config === null || config === void 0 ? void 0 : config.utf8Decoder) !== null && _r !== void 0 ? _r : defaultRoleAssumers.fromUtf8,
        utf8Encoder: (_s = config === null || config === void 0 ? void 0 : config.utf8Encoder) !== null && _s !== void 0 ? _s : defaultRoleAssumers.toUtf8,
    };
};
